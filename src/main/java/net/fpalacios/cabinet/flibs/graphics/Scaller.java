package net.fpalacios.cabinet.flibs.graphics;
...
public class Scaller {
	...
	public static BufferedImage basicScale(BufferedImage img, int targetW, int targetH) {
	...
	public static BufferedImage progressibeBilinear(BufferedImage img, int targetW, int targetH) {
