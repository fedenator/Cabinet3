...
public class Assets
{
	// ObjectMapper para deserializar los archivos json
	...
	public static BufferedImage convertToCompatibleImage(BufferedImage image)
	{
	    ...
	    convertedImage = gc.createCompatibleImage(
			image.getWidth(),
	        image.getHeight(),
	...
	/**
	 * Carga y deserializa un archivo JSON
	 */
	public static <T> T loadJson(String path, Class<T> c) throws IOException
	{
		return jsonMapper.readValue(new File(path), c);
	} 
}
