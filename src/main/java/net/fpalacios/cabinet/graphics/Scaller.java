package net.fpalacios.cabinet.graphics;
...
public class Scaller
{
	...
	{
		// No se puede escalar una imagen vacia
		...
		{
			return recursiveBilinear(img, targetW, targetH);
		}
		...
		{
			return simpleBilinear(img, targetW, targetH);
		}
	}
	
	public static BufferedImage simpleBilinear(BufferedImage img, int targetW, int targetH)
	{
	...
	public static BufferedImage recursiveBilinear(BufferedImage img, int targetW, int targetH)
	{
