package net.fpalacios.cabinet.graphics.animation;

import java.awt.EventQueue;
import java.util.ArrayList;


// TODO(fpalacios): Rescribir usando iterators
/**
...
public class AnimationChain extends Animation{
	...
	private void next()
	{
		if ( counter == animations.size() ) finish();
		else animations.get(counter).start( () -> next() );
		counter++;
	}
